...
$(document).ready(function() {
    "use strict";
    var a, b = fa ? "touchstart" : "click", c = ".wrapper", d = ".element-reveal-left", e = ".element-reveal-right", f = ".side-navigation-wrapper", g = ".side-nav-show, a.side-nav-show", h = ".side-nav-hide a, .one-page-nav .side-navigation .scroll-link", i = ".no-scroll", j = ".element-show-left", k = ".element-show-right", l = "easeInOutQuint", m = {
        init: function() {
            if (!$(f).length)
                return !1;
            $("body").data("aux-nav", !1);
            ...
            $(g).on(b, function(d) {
                ...
                $(f).hasClass("active"))
                    ...
                    aa ? ($(c).addClass(p + " inactive " + a).css({
                        transitionTimingFunction: ea[l]
                    }),
        ...
        init: function() {
            ...
            $(p).on(b, function(b) {
                ...
                aa ? $(n).addClass("active " + a).css({
                    transitionTimingFunction: ea[s]
                }) : $(n).addClass("active"),
                $(n).on(da, function(a) {
                    return a.target === $(this)[0] && (a.stopPropagation(),
                    y.state(!0),
    ...
    }, u = ".side-navigation-wrapper nav, .overlay-navigation-wrapper nav", v = ".sub-menu", w = ".contains-sub-menu", x = {
        init: function() {
            function a(a) {
            ...
            function c(a) {
                $(a).parents().eq(2).is("nav") ? $(a).closest("nav").find(v).css({
                    height: 0
            ...
            $(u).find(w).each(function() {
                $(this).on(b, function(b) {
                    ...
                    $(this).parent().hasClass("current") ? $(this).closest("ul").find("li").removeClass("current") : ($(this).parents().eq(2).is("nav") && $(this).parents().eq(2).find("li").removeClass("current"),
                    ...
                    d($(this), !1)),
                    void $(this).siblings(v).on(da, function(a) {
        ...
        state: function(a) {
            fa ? a ? $("body").addClass("aux-navigation-active") : $("body").removeClass("aux-navigation-active") : a ? $("body").addClass("aux-navigation-active") : $("body").data("aux-nav") || $("body").removeClass("aux-navigation-active")
        }
    }, z = ".header, .header-inner, .logo, .logo a, .header .navigation", A = {
        init: function() {
            fa || $(window).on("scroll", function() {
                A.state(!0)
            }),
            $(window).on("resize", function() {
                A.state(!1)
    ...
    }, F = ".header", G = ".tabs", H = ".tab-trigger-click", I = ".accordion", J = "icon-plus", K = "icon-minus", L = ".accordion-content", M = ".accordion-trigger-click", N = ".collapsable", O = ".box.dismissable", P = 300, Q = "swing", R = ".dropdown", S = ".thumbnail", T = ".overlay-info, img", U = ".overlay-info", V = 400, W = "easeInOutQuint", X = ".background-image-container", Y = {
        init: function() {
            Y.tabs(),
            Y.accordions(),
            Y.collapsable(),
        ...
        collapsable: function() {
            ...
            $(N).each(function() {
                var d = $(this)
                  , e = !!d.is("[data-include-margin]");
                d.hasClass("active") && a(d, e),
                d.on(b, function(b) {
                    b.preventDefault();
                    var d = $(this);
                    a($(this), e);
        ...
        dropdown: function() {
            $(R).each(function() {
                $(this).children("a, .button, button").each(function() {
                    function a(a) {
                        return c = $(a).children(),
                        d = 0,
                        c.each(function() {
                    ...
                    e.on(b, function(b) {
                        b.preventDefault(),
                        $(R).children("a, .button, button").removeClass("active");
                        var c = $(this).parent().children(".dropdown-list");
                        if ($(this).parent().hasClass("disabled"))
                            return !1;
                        if ($(this).parent().hasClass("list-up") && (d = $(R).children("a, .button, button").outerHeight() + a(c) + 8,
                        c.css({
                            transition: "none",
                    ...
                    var f = function() {
                        $(R).each(function() {
                            $(this).find("a, .button, button").removeClass("active"),
        ...
        rollovers: function() {
            aa ? $(S).each(function() {
                var a, b = $(this).data("hover-speed") ? $(this).data("hover-speed") : V, c = $(this).data("hover-easing") ? $(this).data("hover-easing") : W, d = $(this).data("hover-bkg-opacity") ? $(this).data("hover-bkg-opacity") : 1;
                if ($(this).data("hover-bkg-color")) {
                    ...
                    a = $(this).find(U).css("background-color");
                if ($(this).find(T).css({
                    transitionDuration: b + "ms",
                    transitionTimingFunction: ea[c]
                }),
            ...
            }) : $(S).find(".overlay-link").mouseenter(function() {
                $(this).find(U).css({
                    opacity: 0
                }).stop().animate({
                    opacity: 1
    ...
    }, Z = document.body || document.documentElement, _ = Z.style, aa = void 0 !== _.transition || void 0 !== _.WebkitTransition || void 0 !== _.MozTransition || void 0 !== _.MsTransition || void 0 !== _.OTransition, ba = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
    for (var ca in ba)
        void 0 !== _[ba[ca]] && (a = "-" + ba[ca].replace("Transform", "").toLowerCase());
    var da = "webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend";
    aa && (document.getElementsByTagName("body")[0].className += " transition-support");
    var ea = {
    ...
    ;
    var fa = !1;
    (navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/webOS/i) || navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/Windows Phone/i)) && (fa = !0,
    document.getElementsByTagName("body")[0].className += " mobile");
    var ga = "WebkitAppearance"in document.documentElement.style;
    ga && (document.getElementsByTagName("body")[0].className += " webkit");
    var ha = /constructor/i.test(window.HTMLElement);
    ha && (document.getElementsByTagName("body")[0].className += " safari-browser");
    var ia = document.all && document.addEventListener || "-ms-scroll-limit"in document.documentElement.style && "-ms-ime-align"in document.documentElement.style;
    ia && (document.getElementsByTagName("body")[0].className += " ie-browser");
    var ja = document.all && document.addEventListener;
    ja && (document.getElementsByTagName("body")[0].className += " ie-be-11",
...
!function(a, b, c, d) {
    ...
    function f(b, d, e) {
        ...
        f.each(function() {
            ...
            j) {
                M && f.is("[data-video-bkg]") && f.children("video").css({
                    display: "none"
                });
    ...
    function g(b, c, d, e) {
        ...
        d.lazyLoad) {
            if ((b.find(".tm-loader").length && !l || M) && h(f, b, d),
            ...
            c === g.children().length && ((f.find(".tm-loader").length && !l || M) && h(f, b, d),
            i.find(".tms-caption").show(),
            d.carouselVisible > 1 && f.find(".tms-caption").show(),
            F ? d.carousel ? m(g, 1, 0, 0, 0, 0, 0, 0, 1, "50%", "50%", 1e3, 0, "easeIn", d) : m(i, 1, 0, 0, 0, 0, 0, 0, 1, "50%", "50%", 1e3, 0, "easeIn", d) : d.carousel ? g.animate({
                opacity: 1
            }) : i.animate({
                opacity: 1
            }),
    ...
    var i = function(d, g) {
        var h, i = a.extend({}, a.fn.avalancheSlider.tmsOpts, g), o = a(d), t = this, w = i.fulscreen ? a(c).width() : i.fullwidth ? i.scaleUnder : o.data("width") ? parseFloat(o.data("width")) : parseFloat(o.css("width")), x = i.fulscreen ? a(c).height() : o.data("height") ? parseFloat(o.data("height")) : parseFloat(o.css("height")), y = o.find(".tms-slides"), z = [];
        ...
        if ("" !== E && o.find("#" + E).length ? (history.pushState("", b.title, c.location.pathname + c.location.search),
        A = o.find("#" + E).addClass("active")) : A = y.children("li:first-child").addClass("active"),
        i.carousel || (F ? a(this).not(".active").css({
            transition: "none",
        ...
        (o.is("[data-nav-dark]") || A.is("[data-nav-dark]")) && (o.addClass("tms-nav-dark"),
        ...
        if (i.navPagination && y.children().length > 1) {
            for (var I = a("<div>").addClass("tms-pagination").appendTo(o), J = 1; J < y.children().length + 1; J++)
                o.find(I).append('<a href="#" id="tms-pagination-' + J + '" data-index="' + J + '" class="tms-bullet-nav" />');
            var L = "bullets" === i.paginationType ? o.find(".tms-bullet-nav") : o.find(".tms-thumb-nav");
            L.each(function() {
                a(this).on("click", function() {
                    return A = o.find("li.active"),
                    !a(this).hasClass("active") && (i.autoAdvance && o.data("loaded") && t.resetSlideshow(),
                    parseFloat(a(this).data("index")) > parseFloat(I.find(".active").data("index")) ? t.slideTo(a(this).data("index"), "next") : t.slideTo(a(this).data("index"), "prev"),
                    !1)
                })
            }),
            I.children().eq(o.find("li.active").index()).addClass("active"),
            i.lazyLoad && I.css({
                display: "block"
            })
        }
        if (i.navKeyboard && y.children().length > 1) {
            ...
            a(b).on("keydown", function(a) {
                return N[a.keyCode] = !0,
                (!N[37] || !N[39]) && void (N[37] ? (i.autoAdvance && o.data("loaded") && t.resetSlideshow(),
                i.lazyLoad ? t.prevSlide() : o.data("loaded") && t.prevSlide()) : N[39] && (i.autoAdvance && o.data("loaded") && t.resetSlideshow(),
        ...
        t.initSlideshow = function() {
            return !(O || y.children().length < 2) && (i.autoAdvance = !0,
            !M && i.pauseOnHover && (y.on("mouseleave ", t.resumeSlideshow),
            y.on("mouseenter ", t.pauseSlideshow)),
            i.showProgressBar && (U = a("<div>").addClass("tms-progress-bar").appendTo(o)),
            t.startSlideshow(),
            X(i.interval),
            P = (new Date).getTime(),
            S = i.interval,
        ...
        t.startSlideshow = function(a) {
            ...
            O = setInterval(function() {
                a !== i.interval && (clearInterval(O),
                a = i.interval,
                S = i.interval,
                t.startSlideshow()),
                P = (new Date).getTime(),
                "undefined" != typeof U && U.css({
                    transition: "none",
                    width: "0px"
                }),
                X(i.interval),
        ...
        t.pauseSlideshow = function() {
            return !(T || !O) && (clearInterval(O),
            Q = (new Date).getTime(),
            R = S - (Q - P) < 50 ? 50 : S - (Q - P),
            S = 0 === S ? i.interval : R,
            "undefined" != typeof U && U.stop().css({
                width: U.width() + "px"
            }),
            T = !0,
        ...
        t.endSlideshow = function() {
            ...
            O = "",
            T = !1,
            !M && i.pauseOnHover && (y.off("mouseleave ", t.resumeSlideshow),
            y.off("mouseenter ", t.pauseSlideshow)),
            "undefined" != typeof U && U.remove(),
            void (i.onSlideshowEnd && i.onSlideshowEnd()))
        }
        ;
        var X = function(a) {
            return "undefined" != typeof U && void (F ? (clearTimeout(V),
        ...
        t.nextSlide = function() {
            ...
            if (b = a.inArray(c, z) + 1 === 0 ? 1 : a.inArray(c, z) + 1,
        ...
        t.prevSlide = function() {
            ...
            A = o.find("li.active");
            var c = z[a.inArray(A.attr("id"), z) - 1];
            if (b = a.inArray(c, z) + 1 === 0 ? y.children().length : a.inArray(c, z) + 1,
            i.carousel && i.carouselVisible > 1) {
                var d = q(o, i);
        ...
        t.slideTo = function(b, c) {
            ...
            c || (A = o.find("li.active")),
            o.data("transitioning") || b === a.inArray(A.attr("id"), z) + 1)
                return !1;
            p(o, b);
            var d = o.width()
              , e = o.height()
            ...
            W = setTimeout(function() {
                m(A, 1, -g * c, -k * c, 0, 0, 0, 0, l, "50%", "50%", i.speed, 0, K[i.easing], i),
                m(f, 1, 0, 0, 0, 0, 0, 0, 1, "50%", "50%", i.speed, 0, K[i.easing], i)
      ...
      , m = function(b, c, d, e, f, g, h, i, j, k, l, m, o, p, q) {
        ...
        s.transitionProperty = I + ", opacity",
      ...
      , n = function(a, b) {
        ...
        v(c, "play", b),
        !(b.carouselVisible > 1) && void (e && !M || o(c, b))
    }
      , o = function(b, c) {
        b.find(".tms-caption").not(".no-transition").show().each(function() {
            var b = a(this)
              ...
              , h = a(this).data("e") ? K[b.data("e")] : K[c.easing]
              , i = null;
            F ? (clearTimeout(i),
      ...
      , v = function(b, c, d) {
        ...
        try {
            if (b.find("iframe").length) {
                ...
                b.addClass("video-playing")) : (w[e].pause(),
                b.removeClass("video-playing")) : "undefined" != typeof f && f.indexOf("youtu") > -1 && (e = e.replace("#", ""),
                "play" === c && d.autoPlay ? (x[e].playVideo(),
                b.addClass("video-playing")) : (x[e].pauseVideo(),
      ...
      , A = function(d, e, f, g) {
        ...
        var i = e.closest("li")
          ...
          , l = new Date;
        if (e.attr("id", "video-" + l.getTime()),
        "undefined" != typeof j && j.indexOf("vimeo") > -1) {
            if (e.attr("src", e.attr("src").replace("?api=1", "") + "?&amp;player_id=" + e.attr("id")).addClass("vimeo"),
            i.is("[data-video-bkg-vimeo]") && e.attr("src", e.attr("src") + "&autoplay=0&amp;title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;background=1").addClass("vimeo"),
            !y) {
                y = !0;
            ...
            a(".vimeo").each(function() {
                a(this).on("load", function() {
                    var b = a(this)
                      ...
                      , e = b.closest("li")
                      , i = !!e.hasClass("active");
                    w[c] = new Vimeo.Player(a(c)),
                    i && f.autoPlay && (w[c].play().catch(function(a) {
                        switch (a.name) {
                        case "PasswordError":
                            console.log("The video is password-protected and the viewer needs to enter the password first");
                            break;
                    ...
                    w[c].setVolume(1),
                    (f.muteBkgVideo || e.is("[data-mute-video]")) && w[c].setVolume(0),
                    w[c].on("progress", function(a) {
                        h(d, e, f),
                        e.addClass("video-bkg-loaded"),
                        o(e, f)
                    }),
                    w[c].on("ended", function() {
                        f.replayOnEnd && vp.api("play"),
            ...
            i.is("[data-video-bkg-youtube]") && e.attr("src", e.attr("src") + "&amp;controls=0&amp;showinfo=0&amp;rel=0&amp;modestbranding=0&amp;loop=1&amp;iv_load_policy=3&amp;playlist=" + e.attr("src").split("embed/")[1].substring(0, 11)).addClass("youtube"),
            a("body").hasClass("safari-browser") && i.hasClass("active") && (e.attr("src", e.attr("src") + "&amp;autoplay=1"),
            h(d, i, f),
                    ...
                    x[c] = new YT.Player(c,{
                        events: {
                            onStateChange: function(a) {
                                a.data === YT.PlayerState.PLAYING && e.is("[data-video-bkg-youtube]") && !M && (h(d, e, f),
                                e.addClass("video-bkg-loaded"),
                                o(e, f)),
                                a.data === YT.PlayerState.ENDED && (f.replayOnEnd && x[c].playVideo(),
                                f.nextSlideOnEnd && g.nextSlide())
                            },
                            onReady: function(a) {
                                i && f.autoPlay && (x[c].playVideo(),
                                e.addClass("video-playing")),
                                (f.muteBkgVideo || e.is("[data-mute-video]")) && x[c].mute()
                            },
                            onError: function(a) {
            ...
            e[0].addEventListener("ended", u, !1);
            var s = b.getElementById(e.attr("id"))
              , t = !!i.hasClass("active");
            t && f.autoPlay && (s.load(),
            s.autoplay = !0,
    ...
    ;
    var C, D = b.body || b.documentElement, E = D.style, F = E.transition !== d || E.WebkitTransition !== d || E.MozTransition !== d || E.MsTransition !== d || E.OTransition !== d, G = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
    for (var H in G)
        E[G[H]] !== d && (C = "-" + G[H].replace("Transform", "").toLowerCase());
    var I = C + "-transform"
      , J = "webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend"
      , K = {
        linear: "cubic-bezier(0, 0, 1, 1)",
        swing: "cubic-bezier(0.42, 0, 0.58, 1)",
        easeOutCubic: "cubic-bezier(.215,.61,.355,1)",
    ...
    N && !a("body").hasClass("ie-browser") && (b.getElementsByTagName("body")[0].className += " ie-browser"),
    function() {
    ...
    var e = function(b, d) {
      ...
      , k = function(b, d, e) {
        ...
        var j = b.is("a") ? b.attr("href") : "#" + b.attr("id")
          ...
          , n = b.is('[data-content="inline"]') || b.is("[data-modal-mode]") && !b.is('[data-content="iframe"]')
    ...
    var b = function(b, c) {
        ...
        h.startCountdown = function() {
            var b = g.data("countdown-date") ? new Date(g.data("countdown-date")).getTime() : new Date(f.toDate).getTime()
              , c = String(g.data("unit-type")).split(";")
              , d = "days"
              , e = "hours"
              , h = "mins"
              , i = "secs";
            ...
            var j = function(a) {
                return a < 10 && f.zeroPadding && (a = "0" + a.toString()),
                a
            }
              , k = function() {
    ...
    var e = function(d, e) {
        ...
        var i = function() {
            var a = b.createElement("span")
              , c = a.style;
            return c.cssText = "position:sticky;position:-webkit-sticky;position:-ms-sticky;",
            c.position.indexOf("sticky") !== -1
        }();
        g.useCSS = !!d.is("[data-use-css]") || g.useCSS,
        g.extraSpaceTop = d.data("extra-space-top") ? d.data("extra-space-top") : "auto" != d.css("top") ? parseInt(d.css("top"), 10) : g.extraSpaceTop,
        g.extraSpaceBottom = d.data("extra-space-bottom") ? d.data("extra-space-bottom") : g.extraSpaceBottom,
        g.pushSection = d.data("push-section") ? d.data("push-section") : g.pushSection,
        g.threshold = d.data("threshold") ? d.data("threshold") : g.threshold;
        var j = (a(c).scrollTop(),
        d.offset().top)
          , k = !1;
        i && g.useCSS ? d.css({
            top: g.extraSpaceTop + "px"
        }) : (h(d, g),
        d.data("startup", !0).data("orignDistance", j).css({
            width: "100%",
            display: "flex",
        ...
        a(c).on("scroll resize", function() {
            f(d),
            d.data("startup") || h(d, g),
            a(c).width() >= g.breakpoint && k ? (k = !1,
            j = d.offset().top,
            d.data("orignDistance", j)) : a(c).width() < g.breakpoint && (k = !0)
        }),
        d.wrapAll("<div class='freeze-wrapper' />"),
        f(d))
    }
      , f = function(a) {
...
!function(a, b, c, d) {
    ...
    var e = function(b, d) {
        ...
        b = a(b);
        var f = function(b) {
            var d = a(c).height() / 2 - e.winHeight / 2
              , f = a(c).width() / 2 - e.winWidth / 2;
        ...
        b.on("click", function(c) {
            "email" == a(this).data("network") ? a(this).attr("href", "mailto:" + a(this).data("email") + "?&subject=" + a(this).data("subject") + "&body=" + a(this).data("description") + " - " + a(this).data("url")) : (c.preventDefault(),
            g(b, b.data("network")))
        })
    };
...
$(document).ready(function() {
    ...
    var a = ".header"
      ...
      , Da = ".no-page-fade, .no-page-fade a, .side-nav-show, .overlay-nav-show, .mail-link, .lightbox-link, .contains-sub-menu, .blog .pagination-previous, .blog .pagination-next, .disabled, .scroll-link, .navigation-show a, a.navigation-show, .social-list a"
      , Ea = ".socialize"
      , Fa = 800
      , Ga = 600
      , Ha = "webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend"
      , Ia = {
        init: function() {
            ...
            Ia.retinize(),
            Ia.equalize(768),
            Ia.parallax(".parallax", !0, !1, !0),
            Ia.fullScreenSection(),
            Ia.masonry(),
            Ia.logoSlider(),
            Ia.heroSlider(),
            Ia.testimonialSlider(),
            Ia.teamSlider(),
            Ia.recentSlider(),
            Ia.carouselSlider(),
            Ia.contentSlider(),
            ...
            Ia.sliderAuxNav(),
            Ia.lightbox(),
            Ia.counter(".stat", ".stat-counter", !1),
            Ia.countdown(".countdown"),
            Ia.horizon(".horizon", ".parallax .horizon", "easeInOutQuint", !1, 1),
            Ia.freeze(".freeze"),
            Ia.videos(),
            Ia.mediaElement(),
            Ia.signupForm(),
            Ia.contactForm(),
            Ia.enablePlaceHolder();
            try {
                document.getElementsByClassName("map-canvas") && google.maps.event.addDomListener(window, "load", Ia.googleMap)
            } catch (a) {}
            Ia.fixedFooter(),
            Ia.pageFade(),
            Ia.scrollToSection(),
            Ia.socialize(),
            $("body").hasClass("preload-page") && Ia.preloadPage()
        },
        retinize: function() {
            $(i).retinizeImages()
        },
        ...
        parallax: function(a, b, c, d) {
            $(a).snowBridge({
                ...
                parallaxFactor: .6,
                onLoaded: function() {
                    Ia.horizon(".horizon", "", "easeInOutQuint", !1, 1)
                }
            })
        },
        ...
        fullScreenSection: function() {
            var a = function() {
                ...
                if ($(k).find(l).length > 1) {
                    ...
                    var g = function(a) {
                      ...
                      , h = function(a) {
                        ...
                        c && Ia.isElementVisible($(k), p) ? $(b).css({
                            opacity: 1,
                            visibility: "visible"
                        }) : $(b).css({
                            opacity: 0,
              ...
              , b = function() {
                $(l).each(function() {
                    var a = $(this)
                      , b = a.find(".background-image-wrapper")
        ...
        masonry: function() {
            $(q).each(function() {
                ...
                c.data("layout-mode")) {
                    ...
                    c.is(".masonry-set-dimensions, .masonry-set-dimensions-2") ? (c.is(".full-width.no-margins") && Ia.masonryWrapperWidth(c, d),
                    b = Ia.masonryColWidth(c, d),
                    Ia.masonryThumbSizes(c, d, Ia.masonryColWidth(c, d))) : b = ".grid-sizer";
                    ...
                    imagesLoaded(d, function() {
                        ...
                        $(window).on("resize", function() {
                            ...
                            c.is(".full-width.no-margins") && Ia.masonryWrapperWidth(c, d),
                            Ia.masonryThumbSizes(c, d, Ia.masonryColWidth(c, d)),
                            v ? d.isotope({
                                transitionDuration: u,
                                masonry: {
                                    columnWidth: ".grid-sizer" !== b ? Ia.masonryColWidth(c, d) : ".grid-sizer"
                                }
        ...
        signupForm: function() {
            $(S).submit(function(a) {
                ...
                k || (l = !0),
                e.val() && !Ia.isValidEmail(e.val()) ? (c.hide().text(Z).fadeIn(200),
                e.addClass(T)) : m = !0,
                "" !== f.val())
                    return !1;
                if (k && e.val() && !Ia.isValidEmail(e.val()) && c.hide().text(Y + " " + Z).fadeIn(200),
                l && m) {
                    var n = $(g).val();
                    $(g).css({
        ...
        contactForm: function() {
            $(_).submit(function(a) {
                ...
                o || (p = !0),
                e.val() && !Ia.isValidEmail(e.val()) ? (c.hide().text(ga).fadeIn(200),
                e.addClass(aa)) : q = !0,
                "" !== f.val())
                    return !1;
                if (o && e.val() && !Ia.isValidEmail(e.val()) && c.hide().text(fa + " " + ga).fadeIn(200),
                p && q) {
                    var r = $(g).val();
                    $(g).css({
                        width: $(g).outerWidth() + "px"
        ...
        pageFade: function() {
            return !!Aa && void $(Ca).each(function() {
                ...
                $(this).not(Da).on("click", function(a) {
                    a.preventDefault();
                    var b = this.href;
                    $("body").hasClass("transition-support") ? $(Ba).addClass("page-fade-out").on(Ha, function(a) {
                        return a.stopPropagation(),
                        a.target === $(this)[0] && void Ia.goToNewPage(b)
                    }) : Ia.goToNewPage(b)
                })
            })
        },
